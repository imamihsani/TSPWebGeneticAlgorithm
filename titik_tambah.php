<div class="page-header">
  <h1 style="color:black">Tambah Titik</h1>
</div>
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" id="penerima" name="penerima" value="<?= set_value('penerima') ?>"  />
      </div>
      <div class="form-group">
        <label>No. Telepon (Tanpa format 62 atau 0) <span class="text-danger">(Harap diisi dengan tanda " - " jika tidak ada)</span></label>
        <input class="form-control" type="text" id="notelp" name="notelp" value="<?= set_value('notelp') ?>"  />
      </div>
      <div class="form-group">
