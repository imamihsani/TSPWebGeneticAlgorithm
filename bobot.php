...
<form class="form-inline">
    ...
    <div class="form-group">
        <a class="btn btn-default" href="cetak.php?m=bobot&kode_kelompok=<?= set_value('kode_kelompok') ?>" target="_blank"><span class="glyphicon glyphicon-plus"></span> Cetak</a>
    </div>
</form>
<?php if (input_get('kode_kelompok')) : ?>
    <hr />
    <form method="post">
