<div class="page-header">
    <h1 style="color:black;">Optimalisasi Rute</h1>
</div>
<style>
    #right-panel {
            ...
            <div class="row">
                <div class="col-md-6">
                    <form action="?">
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="debug" <?= (isset($_GET['debug'])) ? 'checked' : '' ?> name="debug" /> Tampilkan tahap algoritma
                            </label>
                        </div>
...
<div class="panel panel-warning  <?= $success && isset($_GET['num_kromosom']) ? '' : 'hidden' ?>">
    <div class="panel-heading">
        <center><h3 class="panel-title">REKOMENDASI RUTE OPTIMAL</h3></center>
    </div>
    <div class="panel-body">
        <div class="row">
            <div class="col-md-10">
        ...
        function calculateAndDisplayRoute(directionsService, directionsDisplay, map) {
            directionsService.route({
                ...
                if (status === 'OK') {
                    ...
                    window.alert('Tidak bisa menemukan rute karena ' + status);
                }
            });
        }
